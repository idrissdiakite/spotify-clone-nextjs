...
Création d'un clone Spotify (basé sur le compte d'[ilovethistrack.com](https://open.spotify.com/user/ilovethistrack.com?si=84c31f245c86476f)) afin d'apprendre/tester le framework NextJs ainsi que de me perfectionner avec Tailwindcss.
